...
(function(){
  ...
  const CAT={
    navishopper:{kind:'navigallery',idx:'02',kicker:'CASE // SOCIAL',title:'NAVI<br>SHOPPER',
      ...
      desc_pl:'Kompleksowa obecność w social mediach marki shopping-tech — od premiery, przez treści na co dzień, po kampanie płatne. Żywy system szablonów, animacji i kierunku wizualnego, który skalował się razem z marką.',
    ...
    dermanium:{kind:'dermgallery',idx:'03',kicker:'CASE // BRAND',title:'DERMA<br>NIUM',
      ...
      desc_pl:'Sklep, kampanie sezonowe i kreacje na Amazon dla marki kosmetycznej stworzonej pod marketplace. Jeden oszczędny system, który wygląda równie dobrze w miniaturze 200×200, w story i na półce.',
    ...
    mit:{kind:'mitgallery',idx:'04',kicker:'CASE // BRAND',title:'MADE IN<br>TURKIC',
      ...
      desc_pl:'Materiały social i kampanijne dla marketplace działającego w krajach turkijskich. Nocne mapy świata, opowieść geograficzna oparta na trzech filarach i karuzela-zapowiedź nawiązująca do Jedwabnego Szlaku.',
    ...
    systems:{kind:'systems',idx:'07',kicker:'INDEX // SYSTEMS',title:'SYS<br>TEMS',
      ...
      desc_pl:'Pełne księgi marki, które stoją za projektami — systemy logo, palety, typografia i siatki. Kliknij stos, żeby rozwinąć go w całość.',
